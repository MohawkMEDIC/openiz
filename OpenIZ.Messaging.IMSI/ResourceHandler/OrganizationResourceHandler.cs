...
namespace OpenIZ.Messaging.IMSI.ResourceHandler
{
	...
	public class OrganizationResourceHandler : IResourceHandler
	{
		...
		{
			var organizationService = ApplicationContext.Current.GetService<IOrganizationRepositoryService>();
			...
			{
				var providerData = data as Organization;

				if (updateIfExists)
				{
					return organizationService.Save(providerData);
				}
				else
				{
					return organizationService.Insert(providerData);
				}
			}
			else
			{
