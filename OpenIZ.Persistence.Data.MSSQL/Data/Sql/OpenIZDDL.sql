...
(
	...
	CONSTRAINT CK_ActVersionActClassReasonConceptIdConceptClass CHECK (dbo.fn_IsConceptSetMember(ReasonConceptId, 'ActReason') = 1 OR dbo.fn_IsConceptSetMember(ReasonConceptId, 'NullReason') = 1),
