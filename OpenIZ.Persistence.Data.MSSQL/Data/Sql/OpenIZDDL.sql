...
(
	...
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE TIME THE USER WAS CREATED
...
(
	...
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE TIME THE ROLE WAS CREATED
...
(
	...
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE TIME THE POLICY WAS CREATED
...
(
	...
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE TIME THE DEVICE RECORD WAS CREATED
...
(
	...
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE CREATION TIME OF THE APPLICATION
...
(
	...
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE CREATION TIME OF THE OBJECT
...
(
	...
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE CREATIONTIME OF THE CODE SYSTEM
...
(
	...
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE CREATION TIME OF THE CONCEPT VERSION
...
(
	...
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE CREATION TIME
...
(
	...
	Name NVARCHAR(128) NOT NULL, -- THE HUMAN NAME FOR THE EXTENSION
	IsEnabled BIT NOT NULL DEFAULT 0, -- INDICATES WHETHER THE EXTENSION IS ENABLED
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE TIME THE EXTENSION WAS CREATE
...
(
	...
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE TIME THE AUTHORITY WAS CREATED
...
CREATE TABLE AssigningAuthorityScope 
(
	AssigningAuthorityId UNIQUEIDENTIFIER NOT NULL, -- UUID FOR THE AUTHORITY
	ScopeConceptId UNIQUEIDENTIFIER NOT NULL, -- UUID FOR THE CLASS CODE 
	CONSTRAINT PK_AssigningAuthorityScope PRIMARY KEY (AssigningAuthorityId, ScopeConceptId),
	CONSTRAINT FK_AssigningAuthorityScopeAuthority FOREIGN KEY (AssigningAuthorityId) REFERENCES AssigningAuthority(AssigningAuthorityId),
	CONSTRAINT FK_AssigningAuthorityScopeScope FOREIGN KEY (ScopeConceptId) REFERENCES Concept(ConceptId)
);
...
(
	...
	CONSTRAINT FK_EntityIdentifierTypeCreatedBy FOREIGN KEY (CreatedBy) REFERENCES SecurityUser(UserId),
	CONSTRAINT FK_EntityIdentifierTypeObsoletedBy FOREIGN KEY (ObsoletedBy) REFERENCES SecurityUser(UserId),
	CONSTRAINT CK_EntityIdentifierTypeObsoletedBy CHECK (ObsoletionTime IS NOT NULL AND ObsoletedBy IS NOT NULL OR ObsoletionTime IS NULL AND ObsoletedBy IS NULL),
...
(
	...
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE CREATION TIME OF THE ACT
	...
	CONSTRAINT CK_ActVersionActClassReasonConceptIdConceptClass CHECK (ReasonConceptId IS NULL OR dbo.fn_IsConceptSetMember(ReasonConceptId, 'ActReason') = 1 OR dbo.fn_IsConceptSetMember(ReasonConceptId, 'NullReason') = 1),
...
(
	...
	ObsoleteVersionSequenceId NUMERIC(20), -- THE OBSOLETION VERSION OF THE ACT
...
(
	...
	SiteConceptId UNIQUEIDENTIFIER, -- THE SITE WHICH THE SUBSTANCE WAS ADMINISTERED
	...
	CONSTRAINT FK_SubstanceAdministrationSiteConceptId FOREIGN KEY (SiteConceptId) REFERENCES Concept(ConceptId),
...
(
	...
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE TIME THAT THE TAG WAS ATTACHED
...
(
	...
	CreatedBy UNIQUEIDENTIFIER NOT NULL, -- THE USER THAT CREATED THE TAG
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- A TIMESTAMP WHEN THE ENTITY WAS CREATED
...
(
	...
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE TIME THE PROTOCOL HANDLER WAS CREATED
...
(
	...
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE TIME THE PROTOCOL WAS CREATED
...
(
	...
	CONSTRAINT FK_ActNodeActId FOREIGN KEY (ActId) REFERENCES Act(ActId),
...
(
	...
	Quantity INT NOT NULL, -- THE QUANTITY OF ENTITY INSTANCES PARTICIPATING IN THE PARTICIPATION
...
-- TODO: Alerts really really really really need to be re-designed
CREATE TABLE AlertMessage 
(
	AlertMessageId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(), -- UNIQUELY IDENTIFIES THE ALERT MESSAGE
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE TIME THE USER WAS CREATED
	CreatedBy UNIQUEIDENTIFIER NOT NULL, -- THE USER THAT CREATED THE USER
	ObsoletionTime DATETIMEOFFSET, -- WHEN PRESENT, INDICATES THE DATE THE USER ACCOUNT IS NOT LONGER ACTIVE
	ObsoletedBy UNIQUEIDENTIFIER, -- THE USER WHO OBSOLETED THIS RECORD
	UpdatedTime DATETIMEOFFSET, -- THE TIME THE RECORD WAS UPDATED
	UpdatedBy UNIQUEIDENTIFIER, -- THE PERSON WHO UPDATED THE USER RECORD
	FromInfo VARCHAR(128) NOT NULL, -- THE INFORMATION OF THE FROM FIELD
	ToInfo VARCHAR(128) NOT NULL, -- THE INFORMATION OF THE DELIVERY RECIPIENTS IN HUMAN READABLE FORM
	MessageTime DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(), -- THE TIME THE MESSAGE WAS COMPOSED
	Subject VARCHAR(256), -- THE SUBJECT OF THE MESSAGE
	Body TEXT NOT NULL, -- THE BODY OF THE MESSAGE
	Flags INT, -- THE FLAGS APPLICABLE TO THE MESSAGE
	CONSTRAINT PK_AlertMessage PRIMARY KEY (AlertMessageId),
	CONSTRAINT FK_AlertMessageObsoletedBy FOREIGN KEY (ObsoletedBy) REFERENCES SecurityUser(UserId),
	CONSTRAINT CK_AlertMessageObsoletedBy CHECK(ObsoletedBy IS NOT NULL AND ObsoletionTime IS NOT NULL OR ObsoletedBy IS NULL AND ObsoletionTime IS NULL),
	CONSTRAINT FK_AlertMessageCreatedBy FOREIGN KEY (CreatedBy) REFERENCES SecurityUser(UserId),
	CONSTRAINT FK_AlertMessageUpdatedBy FOREIGN KEY (UpdatedBy) REFERENCES SecurityUser(UserId),
	CONSTRAINT CK_AlertMessageUpdatedBy CHECK(UpdatedBy IS NOT NULL AND UpdatedTime IS NOT NULL OR UpdatedBy IS NULL AND UpdatedTime IS NULL)
);

-- ALERT MESSAGE RECIPIENT ASSOCIATION TABLE
CREATE TABLE AlertMessageRecipient
(
	AlertMessageId UNIQUEIDENTIFIER NOT NULL,
	SecurityUserId UNIQUEIDENTIFIER NOT NULL,
	CONSTRAINT PK_AlertMessageRecipient PRIMARY KEY (AlertMessageId, SecurityUserId),
	CONSTRAINT FK_AlertMessageRecipientMessageId FOREIGN KEY (AlertMessageId) REFERENCES AlertMessage(AlertMessageId),
	CONSTRAINT FK_AlertMessageRecipientSecurityUserId FOREIGN KEY (SecurityUserId) REFERENCES SecurityUser(UserId)
);
...
CREATE VIEW MaterialCurrentVersion AS 
	SELECT EntityCurrentVersion.*, Material.FormConceptId, FormConcept.Mnemonic AS FormConceptMnemonic,
		Material.ExpiryDate, Material.IsAdministrative, Material.Quantity, Material.QuantityConceptId,
		QuantityConcept.Mnemonic AS QuantityConceptMnemonic
	FROM Material INNER JOIN EntityCurrentVersion ON (EntityCurrentVersion.EntityVersionId = Material.EntityVersionId)
		LEFT JOIN ConceptCurrentVersion AS FormConcept ON (FormConcept.ConceptId = Material.FormConceptId)
		LEFT JOIN ConceptCurrentVersion AS QuantityConcept ON (QuantityConcept.ConceptId = Material.QuantityConceptId);
