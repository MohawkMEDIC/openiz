...
(
	...
	UpdateTime DATETIMEOFFSET, -- THE UPDATE TIME OF THE OBJECT
...
(
	...
	DeviceEvidence NVARCHAR(64) NOT NULL, -- AN EXTERNAL IDENTIFIER USED BY THE DEVICE TO IDENTIFY ITSELF IN MESSAGES
...
(
	ApplicationId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE APPLICATION ID
...
(
	PhoneticAlgorithmId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE ID FOR THE ALGORITHM
...
(
	ConceptId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE CONCEPT
...
(
	ConceptClassId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE CONCEPT CLASSIFICATION ID
...
(
	ConceptSetId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE CONCEPT SET UNIQUE ID
...
(
	ConceptVersionId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- UNIQUE IDENTIFIER FOR THE CONCEPT VERSION
...
(
	ConceptNameId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- UNIQUE IDENTIFIER FOR THE CONCEPT NAME ID
...
(
	CodeSystemId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE CODE SYSTEM
...
(
	ReferenceTermId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE REFERENCE TERM
...
(
	ConceptReferenceTermId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER OF THE REFERENCE TERM LINK
...
(
	ReferenceTermDisplayNameId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- UNIQUE IDENTIFIER OF THE REFERENCE TERM LINK
...
(
	ConceptRelationshipId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE CONCEPT RELATIONSHIP
...
(
	AssigningAuthorityId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- UNIQUEIDENTIFIER FOR THE ASSIGING AUTHORITY
...
(
	IdentifierTypeId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE IDENTITIFER TYPE
...
CREATE TABLE Act
(
	ActId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE ACT. THIS IS A NUMERIC FOR EASE OF
...
(
	ActVersionId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE VERSION
...
(
	ActIdentifierId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE ACT IDENTIFIER 
...
CREATE TABLE Entity
(
	EntityId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE ENTITY
...
(
	EntityTagId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- UNIQUE IDENTIFIER FOR THE TAG INSTANCE
...
(
	EntityVersionId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE ENTITY
...
(
	EntityAssociationId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- A UNIQUE IDENTIFIER FOR THE ASSOCIATION
...
(
	EntityAddressId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE ADDRESS INSTANCE
...
(
	ValueId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- UNIQUE IDENTIFIER FOR THE COMPONENT VALUE CODE
...
(
	EntityAddressComponentId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE ADDRESS COMPONENT
...
(
	EntityNameId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE NAME INSTANCE
	EntityId UNIQUEIDENTIFIER NOT NULL, -- THE ENTITY TO WHICH THE ASSOCIATION BELONGS
	EffectiveVersionSequenceId NUMERIC(20) NOT NULL, -- THE EFFECTIVE VERSION OF THE ENTITY
...
(
	EntityNameComponentId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE NAME COMPONENT
...
(
	EntityExtensionId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE ENTITY EXTENSION
	ExtensionTypeId UNIQUEIDENTIFIER NOT NULL, -- THE TYPE OF EXTENSION
	ExtensionValue VARBINARY(MAX), -- THE SERIALIZED EXTENSION VALUE
	ExtensionDisplay NVARCHAR(64), -- A DISPLAY VERSION OF THE EXTENSION VALUE
	EntityId UNIQUEIDENTIFIER NOT NULL, -- THE ENTITY TO WHICH THE ASSOCIATION BELONGS
...
(
	EntityIdentifierId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE ENTITY IDENTIFIER 
	EntityId UNIQUEIDENTIFIER NOT NULL, -- THE ENTITY TO WHICH THE ASSOCIATION BELONGS
	IdentifierTypeId UNIQUEIDENTIFIER NOT NULL, -- THE TYPE OF IDENTIFIER
	EffectiveVersionSequenceId NUMERIC(20) NOT NULL, -- THE VERSION WHERE THE IDENTIFIER BECAME ACTIVE
	ObsoleteVersionSequenceId NUMERIC(20), -- THE OBSOLETION VERSION IDENTIFIER
...
(
	EntityTelecomAddressId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE ADDRESS
	EntityId UNIQUEIDENTIFIER NOT NULL, -- THE ENTITY TO WHICH THE ASSOCIATION BELONGS
...
(
	PlaceServiceId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE PLACE SERVICE ASSOCIATION
...
(
	PersonLanguageCommunicationId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE LANGUAGE COMMUNICATION ID 
...
(
	UserEntityId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE USER ENTITY INFORMATION
	UserId UNIQUEIDENTIFIER NOT NULL, -- THE USER THAT ENTITY APPLIES TO
	EntityId UNIQUEIDENTIFIER NOT NULL, -- THE USER THAT IS ASSOCIATED WITH THE ENTITY
	CreationTime DATETIMEOFFSET NOT NULL DEFAULT CURRENT_TIMESTAMP, -- THE CREATION TIME OF THE RECORD
	CreatedBy UNIQUEIDENTIFIER NOT NULL, -- THE USER THAT CREATED THE RECORD
	ObsoletionTime DATETIMEOFFSET, -- THE TIME THE ASSOCIATION IS OBSOLETE
	ObsoletedBy UNIQUEIDENTIFIER, -- THE USER THAT OBSOLETED THE RECORD
	CONSTRAINT PK_UserEntity PRIMARY KEY (UserEntityId),
	CONSTRAINT FK_UserEntityUserId FOREIGN KEY (UserId) REFERENCES SecurityUser(UserId),
	CONSTRAINT FK_UserEntityEntityId FOREIGN KEY (EntityId) REFERENCES Entity(EntityId),
	--CONSTRAINT CK_UserEntityEntityClass CHECK (dbo.fn_AssertEntityClass(EntityId, 'PSN') = 1),
	CONSTRAINT FK_UserEntityCreatedBy FOREIGN KEY (CreatedBy) REFERENCES SecurityUser(UserId),
	CONSTRAINT FK_UserEntityObsoletedBy FOREIGN KEY (ObsoletedBy) REFERENCES SecurityUser(UserId),
	CONSTRAINT CK_UserEntityObsoletionTime CHECK (ObsoletedBy IS NULL AND ObsoletionTime IS NULL OR ObsoletedBy IS NOT NULL AND ObsoletionTime IS NOT NULL)
);


CREATE TABLE ProtocolHandler
(
	ProtocolHandlerId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- THE UNIQUE IDENTIFIER FOR THE PROTOCOL HANDLER
...
(
	ProtocolId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- UNIQUE IDENTIFIER FOR THE Protocol
...
(
	ActNoteId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- NOTE IDENTIFIER
...
(
	EntityNoteId UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID(), -- NOTE IDENTIFIER
