DELETE FROM SEC_USR_ROL_ASSOC_TBL WHERE USR_ID IN (SELECT USR_ID FROM SEC_USR_TBL WHERE USR_NAME IN ('Bob','Lucy', 'SyncUser', 'Administrator'));
DELETE FROM SEC_USR_TBL WHERE USR_NAME IN ('Bob','Lucy', 'SyncUser', 'Administrator');
...
INSERT INTO SEC_USR_TBL (USR_NAME, SEC_STMP, PASSWD, EMAIL, PHN_NUM, EMAIL_CNF, PHN_CNF, CRT_USR_ID)
	VALUES ('Lucy', UUID_GENERATE_V4(), '59ff5973691ff75f8baa45f1e38fae24875f77ef00987ed22b02df075fb144f9', 'lucy@marc-hi.ca', 'tel:+19055751212;ext=4085', TRUE, TRUE, 'fadca076-3690-4a6e-af9e-f1cd68e8c7e8');

INSERT INTO SEC_USR_ROL_ASSOC_TBL (USR_ID, ROL_ID)
	SELECT USR_ID, ROL_ID FROM SEC_USR_TBL, SEC_ROL_TBL 
	WHERE SEC_USR_TBL.USR_NAME = 'Lucy' AND SEC_ROL_TBL.ROL_Name IN ('CLINICAL_STAFF');
