...
namespace OpenIZ.Core.Services.Impl
{
	...
	/// </summary>
	public class LocalApplicationIdentityProviderService : IApplicationIdentityProviderService
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="LocalApplicationIdentityProviderService"/> class.
		/// </summary>
		public LocalApplicationIdentityProviderService()
		{
