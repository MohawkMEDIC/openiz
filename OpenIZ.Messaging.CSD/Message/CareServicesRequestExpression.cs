...
{
	/// <summary>
	/// Represents a care services request expression.
	/// </summary>
	[XmlType("careServicesRequestExpression", Namespace = "urn:ihe:iti:csd:2013")]
	public class CareServicesRequestExpression
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="CareServicesRequestExpression"/> class.
		/// </summary>
		public CareServicesRequestExpression()
		{
